...
public class Tetrominos {
  ...
  void tetrominosFactory()
  {
      ...
      {
          case 1 :
            listeCarre[0][1]= new carre(coordonne.y+0,coordonne.x+1*taill_block,taill_block,Color.GREEN,1,new Point(coordonne.x+0*taill_block+taill_block/2,coordonne.y+1*taill_block+taill_block/2));
            listeCarre[1][1]= new carre(coordonne.y+1*taill_block,coordonne.x+1*taill_block,taill_block,Color.GREEN,1,new Point(coordonne.x+1*taill_block+taill_block/2,coordonne.y+1*taill_block+taill_block/2));
            listeCarre[2][1]= new carre(coordonne.y+2*taill_block,coordonne.x+1*taill_block,taill_block,Color.GREEN,1,new Point(coordonne.x+2*taill_block+taill_block/2,coordonne.y+1*taill_block+taill_block/2));
            listeCarre[3][1]= new carre(coordonne.y+3*taill_block,coordonne.x+1*taill_block,taill_block,Color.GREEN,1,new Point(coordonne.x+3*taill_block+taill_block/2,coordonne.y+1*taill_block+taill_block/2));
          ...
          default:
            ...
            listeCarre[1][1]= new carre(coordonne.y+1*taill_block,coordonne.x+1*taill_block,taill_block,Color.GREEN,1,new Point(coordonne.x+1*taill_block+taill_block/2,coordonne.y+1*taill_block+taill_block/2));
            listeCarre[2][1]= new carre(coordonne.y+2*taill_block,coordonne.x+1*taill_block,taill_block,Color.GREEN,1,new Point(coordonne.x+2*taill_block+taill_block/2,coordonne.y+1*taill_block+taill_block/2));
            listeCarre[2][0]= new carre(coordonne.y+2*taill_block,coordonne.x+0,taill_block,Color.GREEN,1,new Point(coordonne.x+2*taill_block+taill_block/2,coordonne.y+0*taill_block+taill_block/2));
